...
#tblastn -db /home/dnarules/Desktop/CnidarianTranscriptome/databases/$transcriptome -query /mnt/dnarules/Anuj/QueryProtein/$protein -out /home/dnarules/Desktop/Blasted/BlastResults$protein$transcriptome -outfmt "6 qseqid sseqid evalue qseq sseq sstart send" -max_target_seqs 10 -num_threads 20 -evalue 0.0001
